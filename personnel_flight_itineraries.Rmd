...
travel_plans <- str_remove(dir(path, recursive = TRUE, full.names = TRUE), path0)
...
surveys <- names(tabl)
surveys[surveys == "EBS"] <- "Bering Sea"
surveys[surveys == "GOA"] <- "Gulf of Alaska"
surveys[surveys == "AI"] <- "Aleutian Islands"
