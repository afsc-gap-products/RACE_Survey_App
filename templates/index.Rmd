...
<span style="color: red;">**IN CASE OF EMERGENCY:**</span> Find the `r stringr::str_replace( website_content$title_link_inline[grepl(x = website_content$title, pattern = "EMERGENCY Flow Chart")], "../../", ".././") ` and [resource pages](.././docs/safety_illness_and_injury_reporting.html) here. 
