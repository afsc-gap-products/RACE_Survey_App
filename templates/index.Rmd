...
<span style="color: red;">**IN CASE OF EMERGENCY:**</span> Find the `r stringr::str_replace( website_content$title_link_inline[grepl(x = website_content$title, pattern = "EMERGENCY Flow Chart")], "../../", ".././") ` and [resource pages](.././docs/Safety_&_Health_Illness_&_Injury_Reporting.html) here. 
