...
all_files <- taxa_guides %>%
  ...
  dplyr::mutate(
    ...
    reference = paste0("[", str_to_title(title), "](", gsub(" ", "%20", url_loc), ")")
  )
```
...
fish_id <- paste0(
  "<a class='resource-chip' href='./Species_ID_Fish_ID_by_Taxa.html'>ID by Taxa</a>"
)
